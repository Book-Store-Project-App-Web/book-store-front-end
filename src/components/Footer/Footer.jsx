...
import ggPlay from '~/assets/image/footer/ggplay.webp'
import appleStore from '~/assets/image/footer/appstore.webp'
  ...
  return (
    <>
      <footer className='p-8 '>
        <div className='w-10/12 2xl:w-8/12 container mx-auto bg-white p-6 rounded-lg'>
          ...
          {/* <div className='flex justify-center items-center mt-8 space-x-4'>
            <a href='#'>
              <img src='path/to/vnpay.png' alt='VNPAY' className='h-10' />
            </a>
            <a href='#'>
              <img src='path/to/zalopay.png' alt='ZaloPay' className='h-10' />
            </a>
            <a href='#'>
              <img src='path/to/momo.png' alt='MoMo' className='h-10' />
            </a>
            <a href='#'>
              <img src='path/to/shopee.png' alt='ShopeePay' className='h-10' />
            </a>
          </div> */}
